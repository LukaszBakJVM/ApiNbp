...
@Service
public class RatesServicesImpl implements RatesServices {
    private final WebClient webClient;
    private final RatesMapper ratesMapper;
    private final RatesInfoRepository repository;

    public RatesServicesImpl(WebClient.Builder webClient, RatesMapper ratesMapper, RatesInfoRepository repository) {
    ...
    @Override
    public Mono<ResponseCurrency> saveRates(RequestRatesBody requestRatesBody) {
    ...
    @Override
    public Flux<ResponseAllSavedRates> allSavedRates() {
    ...
    @Override
    public Mono<List<String>> findRates() {
    ...
    @Override
    public Flux<ResponseCurrency> findByCurrencyAndTime(String code, LocalDate date) {
